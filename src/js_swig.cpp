...
#define SWIGV8_INIT LeagueGameReader_initialize
...
NODE_MODULE(LeagueGameReader, LeagueGameReader_initialize)
#else
NODE_MODULE_CONTEXT_AWARE(LeagueGameReader, LeagueGameReader_initialize)
#endif
#endif
